...
class PrizesControllerTest < ActionController::TestCase
  ...
  test "should create prize" do
    assert_difference('Prize.count') do
      post :create, prize: { cantidad: @prize.cantidad, descripcion: @prize.descripcion, nombre: @prize.nombre, puntos: @prize.puntos, user_id: @prize.user_id }
    end
  ...
  test "should update prize" do
    patch :update, id: @prize, prize: { cantidad: @prize.cantidad, descripcion: @prize.descripcion, nombre: @prize.nombre, puntos: @prize.puntos, user_id: @prize.user_id }
    assert_redirected_to prize_path(assigns(:prize))
  end
