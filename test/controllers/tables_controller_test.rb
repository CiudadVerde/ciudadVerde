...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { material_id: @table.material_id, puntos: @table.puntos, user_id: @table.user_id }
    end
  ...
  test "should update table" do
    patch :update, id: @table, table: { material_id: @table.material_id, puntos: @table.puntos, user_id: @table.user_id }
    assert_redirected_to table_path(assigns(:table))
  end
